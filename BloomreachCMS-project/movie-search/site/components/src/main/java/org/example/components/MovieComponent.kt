...
class MovieComponent : BaseHstComponent() {
    ...
    override fun doBeforeRender(request: HstRequest, response: HstResponse) {
        ...
        println("******************************************moviecomponent"+request.parameterMap)
        println("******************************************moviecomponent"+ctx.attributes)
        println("******************************************moviecomponent"+request.attributeMap)
        println("******************************************moviecomponent"+request.headerNames)
        println("******************************************moviecomponent"+request.parameterMap)
